...
class CreateCountriesModule extends Migration
{
    ...
    public function down()
    {
        ...
        // Delete module
        Module::where('name', 'country')->forceDelete();
    }
    ...
    protected function createTable()
    {
        Schema::create('countries', function (Blueprint $table) {
            ...
            $table->string('iso_alpha3')->length(3);
            $table->string('currency_code')->length(3);
            $table->string('fips_code')->length(2);
            $table->string('iso_numeric')->length(4);
            $table->string('north')->length(30);
            $table->string('south')->length(30);
            $table->string('east')->length(30);
            $table->string('west')->length(30);
            $table->string('capital')->length(30);
            $table->string('continent_name')->length(15);
            $table->string('continent_code')->length(2);
    ...
    {
        $query = "INSERT INTO `countries` (`code`, `name`, `currency_code`, `fips_code`, `iso_numeric`, `north`, `south`, `east`, `west`, `capital`, `continent_name`, `continent_code`, `languages`, `iso_alpha3`, `geoname_id`) VALUES
